...
uses
  ...
  , IdBuffer
  , IdSSLOpenSSL
  , IdSocketHandle, IdIIOHandlerWebsocket, IdWebSocketTypes
  ;
...
//  {$ENDIF}
  ...
  TIdIOHandlerWebsocketSSL = class(TIdSSLIOHandlerSocketOpenSSL, IIOHandlerWebsocket)
  private
    FIsServerSide: Boolean;
    FBusyUpgrading: Boolean;
    FIsWebsocket: Boolean;
...
function TIdIOHandlerWebsocketSSL.WriteData(aData:TIdBytes; aType:TWSDataCode; aFIN,aRSV1,aRSV2,aRSV3:boolean): integer;
var
  iByte: Byte;
  i, ioffset: NativeInt;
  iDataLength, iPos: Int64;
